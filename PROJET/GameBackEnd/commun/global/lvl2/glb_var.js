...
perso1.src = '../../GameFrontEnd/img/lvl2/spritesheet_perso1/spritesheet1.png';
let perso2 = new Image();
perso2.src = '../../GameFrontEnd/img/lvl2/spritesheet_perso2/spritesheet2.png';
let sky = new Image();
sky.src = '../../GameFrontEnd/img/lvl2/background.png'; /*sky = new Plateforme(0, 0, WIDTH, HEIGHT,"skyblue");*/
let skys = [];
let platform = new Image();
platform.src = '../../GameFrontEnd/img/lvl2/platform.png';
let wall = new Image();
wall.src = '../../GameFrontEnd/img/lvl2/wall.png';
let ground = new Image();
ground.src = '../../GameFrontEnd/img/lvl2/ground.png';
let wall_t = new Image();
wall_t.src = '../../GameFrontEnd/img/lvl2/wall_transparent.png';
let buttons=[];
let buttondesac = new Image();
buttondesac.src = '../../GameFrontEnd/img/lvl2/button2.png';
let buttonact = new Image();
buttonact.src = '../../GameFrontEnd/img/lvl2/button1.png';
let levierdesac = new Image();
levierdesac.src = '../../GameFrontEnd/img/lvl2/levieroff.png';
let levieract = new Image();
levieract.src = '../../GameFrontEnd/img/lvl2/levieron.png';
let gameOverImg = new Image();
gameOverImg.src = "../../GameFrontEnd/img/lvl2/game-over.png";
let doors=[];
let doorclose = new Image();
doorclose.src = "../../GameFrontEnd/img/lvl2/door.png";
let dooropen = new Image();
dooropen.src = "../../GameFrontEnd/img/lvl2/dooropen.png";
let panneau = new Image();
panneau.src = "../../GameFrontEnd/img/lvl2/panneau.png";
