...
} from '../../commun/global/lvl2/glb_var.js';
...
import{p1,p2,drawSprite} from './init.js';

import{victory,gameOver} from './menu.js';

let cmptend = 0;
let jump = new Audio('../../../GameFrontEnd/music/jump.wav');
jump.volume = 0.1;
