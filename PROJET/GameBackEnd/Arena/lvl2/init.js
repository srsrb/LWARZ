...
import {buttons, platforms,skys,WIDTH,HEIGHT,walls,grounds,ctx,wall,ground,platform,canvas,walls_t,wall_t,leviers,doors} from '../../commun/global/lvl2/glb_var.js';
...
import {PlatformsMesure,WallsMesure,GroundsMesure, ButtonsMesure, LeviersMesure,WallsInvisibleMesure,DoorMesure} from './mesure.js';
import {Platform} from './class/platform.js';
import { Levier } from './class/levier.js';
import { jojo,loseSound,winSound} from './menu.js';
...
function initPlatforms(){
    ...
    platforms[0].image = wall_t;
    PlatformsMesure[0].w = 0;
    PlatformsMesure[0].h = 0;
}
...
export{initSky,initButton,initPlayers,initPlatforms,initWalls,initLeviers,p1,p2,drawSprite,initDoor,initPanel};