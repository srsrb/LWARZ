import {ctx,perso1,perso2,
    ...
    gravite,friction,walls,buttons,HEIGHT,wall,wall_t, buttondesac,buttonact,cmpt, platform,doors,walls_t,dooropen
    ...
    LeviersCollision(){// gerer les collisions avec tous les leviers
        for(let i = 0; i < leviers.length; i++){
            if(
                ...
                this.x = LeviersMesure[i].x - this.width;
                this.vx = 0;
            }
            else if(
                this.y + this.height - 1 > (LeviersMesure[i].y) &&
                ...
                if(
                    ...
                    this.y = LeviersMesure[i].y - this.height;    
                    this.vy = 0;
                    this.jumping = false;
                    leviers[0].image = buttonact;
